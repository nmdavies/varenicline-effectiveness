clear
//Open log
log using "Z:\5_effectabstinence\logs\cr_4_statistics_Q2_V4", replace
...
generate var1 = . 
save "Z:\5_effectabstinence\tables\imd cox models", replace
clear
generate var1 = . 
save "Z:\5_effectabstinence\tables\imd logistic models",replace
clear
generate var1 = . 
save "Z:\5_effectabstinence\tables\imd iv models", replace
clear
...
//Decriptive data - the proportion of smokers who attend their GP for smoking cessation treatment by IMD
...
///ANALYSIS 1: LOGISTIC REGRESSION MODELS 
	...
	foreach i in 90 180 270 365 730 1460 {
		...
		regsave dr_varenicline I_imd_dr_varenicline using "Z:\5_effectabstinence\tables\imd logistic models",  pval ci append  addlabel(model, partial adjusted OR `i') 
		...
		regsave dr_varenicline I_imd_dr_varenicline using "Z:\5_effectabstinence\tables\imd logistic models",  pval ci append  addlabel(model, fully adjusted OR `i') 
...
//ANALYSIS 2: PROPENSITY SCORE MATCHING
	...
	//Propensity score matching - for HR cohort, with complete data only, to ensure accuracy of interaction with IMD
	set more off
	...
	foreach i in 90 180 270 365 730 1460 {
		...
		regsave treated I_imd_treated using "Z:\5_effectabstinence\tables\imd logistic models",  pval ci append  addlabel (model, propensity adjusted OR `i') 
...
compress
	...
	//IV regressions with adjustment for interaction of IMD score
		//IV regressions
		foreach i in 90 180 270 365 730 1460 {
		...
		regsave dr_varenicline I_imd_dr_varenicline using "Z:\5_effectabstinence\tables\imd iv models",  pval ci append  addlabel (model, IV regression `i') 
